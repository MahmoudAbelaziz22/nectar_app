              ...
              items: [
                BottomNavigationBarItem(
                  ...
                  icon: SvgPicture.asset(
                    ...
                    color:
                        currentViewIndex == 0 ? MyColors.myGreen : Colors.black,
                ...
                BottomNavigationBarItem(
                  ...
                  icon: SvgPicture.asset(
                    ...
                    color:
                        currentViewIndex == 1 ? MyColors.myGreen : Colors.black,
                ...
                BottomNavigationBarItem(
                  ...
                  icon: SvgPicture.asset(
                    ...
                    color:
                        currentViewIndex == 2 ? MyColors.myGreen : Colors.black,
                ...
                BottomNavigationBarItem(
                  ...
                  icon: SvgPicture.asset(
                    ...
                    color:
                        currentViewIndex == 3 ? MyColors.myGreen : Colors.black,
                    width: getProportionateScreenWidth(24),
                    height: getProportionateScreenWidth(24),
                  ),
                ),
                BottomNavigationBarItem(
                  ...
                  icon: SvgPicture.asset(
                    ...
                    color:
                        currentViewIndex == 4 ? MyColors.myGreen : Colors.black,
                    width: getProportionateScreenWidth(24),
                    height: getProportionateScreenWidth(24),
                  ),
                ),
